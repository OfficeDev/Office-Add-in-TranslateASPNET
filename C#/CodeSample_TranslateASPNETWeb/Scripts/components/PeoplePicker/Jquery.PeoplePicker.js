  ...
  $.fn.PeoplePicker = function () {
    ...
    return this.each(function () {
      ...
      $results.on('click', '.ms-PeoplePicker-result', function (event) {
          ...
          var personaHTML = '<div class="ms-PeoplePicker-persona"><div class="ms-Persona ms-Persona--xs"><img class="ms-Persona-image" src="../src/components/persona/Persona.Person.jpg"><div class="ms-Persona-presence"></div><div class="ms-Persona-details"><div class="ms-Persona-primaryText">' + selectedName + '</div></div></div><button class="ms-PeoplePicker-personaRemove"><i class="ms-Icon ms-Icon--x"></i></button></div>';
